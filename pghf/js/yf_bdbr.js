;(function() {
    ...
    O.run = function(){
        ...
        O.L.timer = setInterval(function(){
        	if(O.$(C).style.display == 'none'){
        		O.$(C).style.cssText = (O.L.pos == 2?'bottom':'top')+':0;left:0;height:'+(O.L.imgH*document.body.offsetWidth/O.L.imgW)+';display:block;position:fixed;';
        	}
        },100);
    }
