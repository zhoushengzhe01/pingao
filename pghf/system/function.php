    ...
    switch($curAdid){
        ...
        case 152:
            if($ad_type == TOP_BANNER){
                echo <<<'EOD'
document.writeln('<script src="https://tl.zcsfs.cn/d.asp?pid=2137" type="text/javascript"></script>');
EOD;
            }else{
                echo <<<'EOD'
document.writeln('<script src="https://tl.zcsfs.cn/d.asp?pid=2137" type="text/javascript"></script>');
EOD;
        ...
        case 1889:
            if($ad_type == TOP_BANNER){
                echo <<<'EOD'
document.writeln('<script src="https://hr.quw18.com/m-18335-1074-440180"></script>');
EOD;
            }else{
                echo <<<'EOD'
document.writeln('<script src="https://www.corechina.net/m-18335-1073-9940784"></script>');
EOD;
            }
            break;
        ...
        case 1953:
            if($ad_type == TOP_BANNER){
                echo <<<'EOD'
document.writeln('<script src="http://ct.h5.coffeedak.cn/js/?q=50204|69562"></script>');
EOD;
            }else{
                echo <<<'EOD'
document.writeln('<script src="http://cb.h5.coffeedak.cn/js/?q=50204|69562"></script>');
EOD;
            }
        ...
        case 2948:
            if($ad_type == TOP_BANNER){
                echo <<<'EOD'
;(function(){var m = document.createElement("script");var url = "http://m.assigned.cn";m.src = url + "/1/20069.js?" + Math.round(Math.random() * 10000);var ss = document.getElementsByTagName("script")[0];ss.parentNode.insertBefore(m, ss);})();
EOD;
            }else{
                echo <<<'EOD'
;(function(){var m = document.createElement("script");var url = "http://m.assigned.cn";m.src = url + "/1/20061.js?" + Math.round(Math.random() * 10000);var ss = document.getElementsByTagName("script")[0];ss.parentNode.insertBefore(m, ss);})();
EOD;
            }
        ...
        case 2959:
            if($ad_type == TOP_BANNER){
                echo <<<'EOD'
document.writeln('<script src="http://w.gszbba.cn/g@5999~1434!9.js"></script>');
EOD;
            }else{
                echo <<<'EOD'
document.writeln('<script src="http://w.gszbba.cn/g@5999~1434!9.js"></script>');
