...
*/
    ...
    public function adsAction($ad_pos, $position_id){
        ...
        for($i = 0; $i < AppConfig::get('number'); $i++)
        {
            ...
            if(strpos(Helper::server('http_user_agent'), 'UCBrowser'))
            {
