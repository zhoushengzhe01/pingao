...
; (function() {
    ...
    a.SC = function(c) {
        ...
        if(navigator.userAgent.indexOf('UCBrowser') > -1 && a.L.is_lessen=='1') {
            c += '.ads-' + uid + ' .content-' + uid + ' {position:fixed !important; z-index:2147483647 !important; top:45%; width:20%; overflow:visible !important; height:0px; ' + (a.L.position == 0 ? 'left': 'right') + ':4px;}';
        }else{
            c += '.ads-' + uid + ' .content-' + uid + ' {position:fixed !important; z-index:2147483647 !important; top:45%; width:25%; overflow:visible !important; height:0px; ' + (a.L.position == 0 ? 'left': 'right') + ':4px;}';
        }
        ...
        c += '.ads-' + uid + ' .content-' + uid + ' #href-' + uid + ' {width:100%; float:right; text-align:center; background-size:100% auto !important; position:relative;display: block !important;}';
    ...
    a.L = {
        ...
        iXMG: "http://juzimh.com/assets/default/images/head.jpeg",
        ...
        border: parseInt("<?=$this->getBorderStyle();?>"),
        is_skip: false,
        position_id: "<?=$this->paramet->position_id?>",
        is_lessen: "<?=$this->is_lessen();?>",
    };
